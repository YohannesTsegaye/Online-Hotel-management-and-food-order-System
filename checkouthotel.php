...
if(isset($_POST['submit'])){
  ...
  // $address = '1';
   ...
   if($check_cart->rowCount() > 0){
         ...
         $insert_order = $conn->prepare("INSERT INTO `orders`(user_id, name, number, email, method,total_products, total_price,verno) VALUES(?,?,?,?,?,?,?,?)");
         $insert_order->execute([$user_id, $name, $number, $email, $method, $total_products, $total_price ,$myrandom]);
